...
const AddPosts = () => {
  ...
  const handleSave = async (e) => {
    ...
    // }
    if (horizontalImage) {
      data.append("verticalImageUrl", horizontalImage);
    }
    if (horizontalImage) {
      data.append("SEOImageUrl", horizontalImage);
    }
    if (horizontalImage) {
      data.append("squareImageUrl", horizontalImage);
    }
    // if (squareImage) {
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              ...
              <Box sx={{ padding: "10px" }}>
                ...
                />
                {renderTextField("SEO Title", "metaTitle", "text", true)}
                {renderTextField(
                  "SEO description",
                  "metaDescription",
                  "text",
                ...
                <Grid container pt={2} style={{ width: "100%" }}>
                  <Grid item xs={12} style={{ width: "100%" }}>
                    <InputLabel sx={inputLabelStyle}>
                      SEO Tag<span style={redStarStyle}>*</span>
                    </InputLabel>
                    <FormControl
                      variant="outlined"
                      fullWidth
          ...
          >
            ...
            >
              {renderTextField("Published Date", "publishedAt", "date", true)}
            </Box>
            <Box
              sx={{
                background: "#fff",
            ...
            >
              <Box sx={{ position: "relative", padding: "10px" }}>
                ...
                <img
                  // src={squareImage}
                  src={
                    squareImage ? URL.createObjectURL(squareImage) : undefined
                  }
                  alt="Selected"
                  style={{
                    width: "100%",
