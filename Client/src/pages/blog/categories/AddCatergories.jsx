...
import { addCategory } from "../../../services/slices/categoriesSlice";
...
const AddCatergories = () => {
  ...
  const handleSave = async (e) => {
    ...
    setLoading(true);
    try {
      await dispatch(addCategory(formValues)).unwrap();
      setFormValues({});
    } catch (error) {
      ...
      >
        ...
        >
          ...
          >
            ...
            <Typography variant="h5">Create New Categories</Typography>
          </Box>
          <Box
            sx={{
              display: "flex",
          ...
          >
            ...
            >
              ...
              {allcategoryList?.length > 0 ? (
                ...
                <Alert severity="warning">No Parent Category Avaliable.</Alert>
              )}
            </Box>
            <Grid item xs={12}>
              <Stack sx={{ pt: 2 }}>
...
export default memo(AddCatergories);
